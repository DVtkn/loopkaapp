    ...
    questions: [
      {
        ...
        type: 'single',
        options: [
          { label: 'Тёплые слова «Ты молодец, я горжусь тобой»', value: 'words', categoryScores: { words: 5 }, scaleId: 'c_closeness' },
          { label: 'Приготовленный ужин или заваренный чай', value: 'acts', categoryScores: { acts: 5 }, scaleId: 'e_safety' },
          { label: 'Крепкие долгие объятия и массаж плеч', value: 'touch', categoryScores: { touch: 5 }, scaleId: 'c_closeness' },
          { label: 'Возможность посидеть вместе и спокойно поговорить без гаджетов', value: 'time', categoryScores: { time: 5 }, scaleId: 'c_closeness' },
          { label: 'Любимое лакомство или приятный сюрприз', value: 'gifts', categoryScores: { gifts: 5 }, scaleId: 'c_closeness' },
        ],
      },
      {
        id: 'q-s2-2',
        ...
        type: 'single',
        options: [
          { label: 'Критика, холодные или язвительные слова', value: 'words_hurt', categoryScores: { words: 5 }, scaleId: 'r_repair' },
          { label: 'Постоянное отвлечение на телефон, когда мы вместе', value: 'time_hurt', categoryScores: { time: 5 }, scaleId: 'c_closeness' },
          { label: 'Отказ от тактильности или дистанцирование тела', value: 'touch_hurt', categoryScores: { touch: 5 }, scaleId: 'c_closeness' },
          { label: 'Забытые обещания и нежелание помочь в быту', value: 'acts_hurt', categoryScores: { acts: 5 }, scaleId: 'e_safety' },
          { label: 'Игнорирование важных для меня дат и праздников', value: 'gifts_hurt', categoryScores: { gifts: 5 }, scaleId: 'v_future' },
        ],
      },
      {
        id: 'q-s2-3',
        ...
        type: 'single',
        options: [
          { label: 'Билеты на совместную поездку или концерт', value: 'time', categoryScores: { time: 5 }, scaleId: 'c_closeness' },
          ...
          { label: 'Письмо или открытка с искренними чувствами', value: 'words', categoryScores: { words: 5 }, scaleId: 'c_closeness' },
          { label: 'Сертификат в спа на массаж для двоих', value: 'touch', categoryScores: { touch: 5 }, scaleId: 'c_closeness' },
          { label: 'Помощь с организацией дела, где мне было трудно', value: 'acts', categoryScores: { acts: 5 }, scaleId: 'e_safety' },
        ],
      },
      {
        id: 'q-s2-4',
        ...
        type: 'scale',
        options: [
          { label: 'Нейтрально', value: 1, categoryScores: { touch: 1 }, scaleId: 'c_closeness' },
          { label: 'Приятно', value: 3, categoryScores: { touch: 3 }, scaleId: 'c_closeness' },
          { label: 'Чувствую прилив счастья и спокойствия', value: 5, categoryScores: { touch: 5 }, scaleId: 'c_closeness' },
        ],
      },
      {
        id: 'q-s2-5',
        ...
        type: 'scale',
        options: [
          { label: 'Не имеет большого значения', value: 1, categoryScores: { acts: 1 }, scaleId: 'e_safety' },
          { label: 'Иногда приятно', value: 3, categoryScores: { acts: 3 }, scaleId: 'e_safety' },
          { label: 'Это высшее проявление заботы', value: 5, categoryScores: { acts: 5 }, scaleId: 'e_safety' },
        ],
      },
      {
        id: 'q-s2-6',
        ...
        options: [],
        tradeOffItems: [
          { id: 'words', label: 'Слова поддержки и восхищения', scaleId: 'c_closeness' },
  ...
  // C1: Наш идеальный день (Креативный)
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: 'single',
        options: [
          { label: '90% вместе — обожаю каждую минуту вдвоём', value: 'all_together', categoryScores: { closeness: 5 }, scaleId: 'c_closeness' },
          { label: '70% вместе, 30% на свои хобби и чтение', value: 'balanced', categoryScores: { balance: 5 }, scaleId: 'a_autonomy' },
          { label: '50% вместе, 50% автономии для перезагрузки', value: 'independent', categoryScores: { autonomy: 5 }, scaleId: 'a_autonomy' },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        scaleId: 'c_closeness',
        options: [
          { label: '1 - Редко', value: 1, scaleId: 'c_closeness' },
          { label: '2', value: 2, scaleId: 'c_closeness' },
          { label: '3 - Умеренно', value: 3, scaleId: 'c_closeness' },
          { label: '4', value: 4, scaleId: 'c_closeness' },
          { label: '5 - Абсолютно', value: 5, scaleId: 'c_closeness' },
        ],
      },
      {
        id: 'q-s4-2',
        ...
        scaleId: 'c_closeness',
        options: [
          { label: '1 - Угасло', value: 1, scaleId: 'c_closeness' },
          { label: '2', value: 2, scaleId: 'c_closeness' },
          { label: '3 - Волнообразно', value: 3, scaleId: 'c_closeness' },
          { label: '4', value: 4, scaleId: 'c_closeness' },
          { label: '5 - Очень ярко', value: 5, scaleId: 'c_closeness' },
        ],
      },
      {
        id: 'q-s4-3',
        ...
        scaleId: 'v_future',
        options: [
          { label: '1 - Не уверен(а)', value: 1, scaleId: 'v_future' },
          { label: '2', value: 2, scaleId: 'v_future' },
          { label: '3 - Скорее да', value: 3, scaleId: 'v_future' },
          { label: '4', value: 4, scaleId: 'v_future' },
          { label: '5 - Полная решимость', value: 5, scaleId: 'v_future' },
        ],
      },
      {
        id: 'q-s4-4',
        ...
        type: 'single',
        options: [
          { label: 'Страсть и новизна впечатлений', value: 'passion', scaleId: 'c_closeness' },
          { label: 'Глубокие душевные разговоры без спешки', value: 'intimacy', scaleId: 'c_closeness' },
          { label: 'Четкие совместные цели и договоренности', value: 'commitment', scaleId: 'v_future' },
        ],
      },
      {
        id: 'q-s4-5',
        ...
        options: [],
        tradeOffItems: [
          { id: 'intimacy', label: 'Эмоциональная близость и доверие', scaleId: 'c_closeness' },
          { id: 'passion', label: 'Страсть, влечение и романтика', scaleId: 'c_closeness' },
          { id: 'commitment', label: 'Надёжность, долгосрочность и цели', scaleId: 'v_future' },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        type: 'single',
        options: [
          { label: 'Бурно, с повышенными тонами, но быстро остывали', value: 'expressive', scaleId: 'r_repair' },
          { label: 'Молчанием, холодным игнорированием и обидами днями', value: 'silent', scaleId: 'e_safety' },
          { label: 'Спокойным обсуждением причин за столом', value: 'calm', scaleId: 'r_repair' },
          { label: 'Эмоции подавлялись, делали вид, что всё отлично', value: 'suppressed', scaleId: 'e_safety' },
        ],
      },
      {
        id: 'q-d1-2',
        ...
        type: 'single',
        options: [
          { label: 'Общий общий котёл, все траты согласовывались', value: 'common', scaleId: 'v_future' },
          { label: 'Один партнёр полностью управлял бюджетом', value: 'one_leader', scaleId: 'v_future' },
          { label: 'Раздельные кошельки и личная финансовая автономия', value: 'split', scaleId: 'a_autonomy' },
          { label: 'Постоянная экономия из страха перед неизвестностью', value: 'scarcity', scaleId: 'e_safety' },
        ],
      },
      {
        id: 'q-d1-3',
        ...
        scaleId: 'r_repair',
        options: [
          { label: 'Никогда, осознанно делаю иначе', value: 1, scaleId: 'r_repair' },
          { label: 'Иногда с удивлением ловлю себя на этом', value: 3, scaleId: 'r_repair' },
          { label: 'Часто повторяю похожие фразы или реакции', value: 5, scaleId: 'r_repair' },
        ],
      },
      {
        id: 'q-d1-4',
        ...
        type: 'single',
        options: [
          { label: 'Традиции совместных ужинов и праздников', value: 'traditions', scaleId: 'v_future' },
          { label: 'Взаимную поддержку в карьере и начинаниях', value: 'support', scaleId: 'v_future' },
          { label: 'Безусловное уважение к личному пространству', value: 'respect', scaleId: 'a_autonomy' },
          { label: 'Чувство юмора и легкость в быту', value: 'humor', scaleId: 'e_safety' },
        ],
      },
      {
        id: 'q-d1-5',
