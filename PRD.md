...
│  PostgreSQL (Neon Cloud) + Drizzle ORM        │ │  • Groq Cloud API (qwen/qwen3.8-27b)   │
...
* При штатном диалоге сервер передает в Groq LLM (`qwen/qwen3.8-27b`) промпт с тремя блоками в ответе:
